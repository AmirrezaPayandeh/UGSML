...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Boolean Based Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.BooleanBasedConstraintImpl#getVariability <em>Variability</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.BooleanBasedConstraintImpl#getConstrainedAttributeInstance <em>Constrained Attribute Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanBasedConstraintImpl extends MinimalEObjectImpl.Container implements BooleanBasedConstraint {
	/**
	 ...
	 * @ordered
	 */
	protected BooleanBasedAttribute constrainedAttributeInstance;
	 ...
	 * @generated
	 */
	protected BooleanBasedConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.BOOLEAN_BASED_CONSTRAINT;
	}
	...
	public void setVariability(VariabilityType newVariability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__VARIABILITY,
	 ...
	 * @generated
	 */
	public BooleanBasedAttribute getConstrainedAttributeInstance() {
		if (constrainedAttributeInstance != null && constrainedAttributeInstance.eIsProxy()) {
			...
			constrainedAttributeInstance = (BooleanBasedAttribute) eResolveProxy(oldConstrainedAttributeInstance);
			if (constrainedAttributeInstance != oldConstrainedAttributeInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__CONSTRAINED_ATTRIBUTE_INSTANCE,
	 ...
	 * @generated
	 */
	public BooleanBasedAttribute basicGetConstrainedAttributeInstance() {
		return constrainedAttributeInstance;
	}
	 ...
	 * @generated
	 */
	public void setConstrainedAttributeInstance(BooleanBasedAttribute newConstrainedAttributeInstance) {
		BooleanBasedAttribute oldConstrainedAttributeInstance = constrainedAttributeInstance;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__VARIABILITY:
			return getVariability();
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__CONSTRAINED_ATTRIBUTE_INSTANCE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__VARIABILITY:
			...
			return;
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__CONSTRAINED_ATTRIBUTE_INSTANCE:
			setConstrainedAttributeInstance((BooleanBasedAttribute) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__VARIABILITY:
			...
			return;
		case UGSMLPackage.BOOLEAN_BASED_CONSTRAINT__CONSTRAINED_ATTRIBUTE_INSTANCE:
			setConstrainedAttributeInstance((BooleanBasedAttribute) null);
			return;
		}
