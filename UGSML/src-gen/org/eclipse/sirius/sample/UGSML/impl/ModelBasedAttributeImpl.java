...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Model Based Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.ModelBasedAttributeImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.ModelBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelBasedAttributeImpl extends MinimalEObjectImpl.Container implements ModelBasedAttribute {
	/**
	 ...
	 * @generated
	 */
	protected ModelBasedAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.MODEL_BASED_ATTRIBUTE;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.MODEL_BASED_ATTRIBUTE__FEATURE_NAME,
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.MODEL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.MODEL_BASED_ATTRIBUTE__FEATURE_NAME:
			return getFeatureName();
		case UGSMLPackage.MODEL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
