...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Material Based Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.MaterialBasedAttributeImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.MaterialBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaterialBasedAttributeImpl extends MinimalEObjectImpl.Container implements MaterialBasedAttribute {
	/**
	 ...
	 * @generated
	 */
	protected MaterialBasedAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.MATERIAL_BASED_ATTRIBUTE;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.MATERIAL_BASED_ATTRIBUTE__FEATURE_NAME,
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.MATERIAL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.MATERIAL_BASED_ATTRIBUTE__FEATURE_NAME:
			return getFeatureName();
		case UGSMLPackage.MATERIAL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
