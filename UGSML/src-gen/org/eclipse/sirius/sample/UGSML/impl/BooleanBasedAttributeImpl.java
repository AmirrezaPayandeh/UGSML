 ...
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.BooleanBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
...
public class BooleanBasedAttributeImpl extends MinimalEObjectImpl.Container implements BooleanBasedAttribute {
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.BOOLEAN_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UGSMLPackage.BOOLEAN_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
