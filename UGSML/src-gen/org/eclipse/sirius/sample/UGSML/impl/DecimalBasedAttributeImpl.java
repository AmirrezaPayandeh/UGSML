 ...
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.DecimalBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
...
public class DecimalBasedAttributeImpl extends MinimalEObjectImpl.Container implements DecimalBasedAttribute {
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.DECIMAL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UGSMLPackage.DECIMAL_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
