...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Animation Based Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.AnimationBasedAttributeImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.AnimationBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnimationBasedAttributeImpl extends MinimalEObjectImpl.Container implements AnimationBasedAttribute {
	/**
	 ...
	 * @generated
	 */
	protected AnimationBasedAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.ANIMATION_BASED_ATTRIBUTE;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.ANIMATION_BASED_ATTRIBUTE__FEATURE_NAME,
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.ANIMATION_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.ANIMATION_BASED_ATTRIBUTE__FEATURE_NAME:
			return getFeatureName();
		case UGSMLPackage.ANIMATION_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
