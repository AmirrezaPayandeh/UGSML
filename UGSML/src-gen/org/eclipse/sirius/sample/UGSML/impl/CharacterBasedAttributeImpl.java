...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Character Based Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.CharacterBasedAttributeImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.CharacterBasedAttributeImpl#isDataStructureArray <em>Data Structure Array</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.CharacterBasedAttributeImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacterBasedAttributeImpl extends MinimalEObjectImpl.Container implements CharacterBasedAttribute {
	/**
	 ...
	 * @ordered
	 */
	protected static final char DEFAULT_VALUE_EDEFAULT = 'A';
	 ...
	 * @generated
	 */
	protected CharacterBasedAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.CHARACTER_BASED_ATTRIBUTE;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__FEATURE_NAME,
	...
	public void setDataStructureArray(boolean newDataStructureArray) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY, oldDataStructureArray,
					dataStructureArray));
	}
	...
	public void setDefaultValue(char newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__DEFAULT_VALUE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__FEATURE_NAME:
			return getFeatureName();
		case UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__DATA_STRUCTURE_ARRAY:
			return isDataStructureArray();
		case UGSMLPackage.CHARACTER_BASED_ATTRIBUTE__DEFAULT_VALUE:
