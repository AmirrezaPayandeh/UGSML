...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Getter Distortion Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.GetterDistortionConstraintImpl#getDistortionAttribute <em>Distortion Attribute</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.UGSML.impl.GetterDistortionConstraintImpl#getDistortionMode <em>Distortion Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetterDistortionConstraintImpl extends MinimalEObjectImpl.Container implements GetterDistortionConstraint {
	/**
	 ...
	 * @generated
	 */
	protected GetterDistortionConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.GETTER_DISTORTION_CONSTRAINT;
	}
			...
			if (distortionAttribute != oldDistortionAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UGSMLPackage.GETTER_DISTORTION_CONSTRAINT__DISTORTION_ATTRIBUTE, oldDistortionAttribute,
							distortionAttribute));
			}
		}
	...
	public void setDistortionMode(ArithmeticOperations newDistortionMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UGSMLPackage.GETTER_DISTORTION_CONSTRAINT__DISTORTION_MODE, oldDistortionMode, distortionMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UGSMLPackage.GETTER_DISTORTION_CONSTRAINT__DISTORTION_ATTRIBUTE:
			if (resolve)
				return getDistortionAttribute();
			return basicGetDistortionAttribute();
		case UGSMLPackage.GETTER_DISTORTION_CONSTRAINT__DISTORTION_MODE:
...
} //GetterDistortionConstraintImpl
