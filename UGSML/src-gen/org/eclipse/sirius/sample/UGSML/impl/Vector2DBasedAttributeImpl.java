...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vector2 DBased Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class Vector2DBasedAttributeImpl extends MinimalEObjectImpl.Container implements Vector2DBasedAttribute {
	/**
	 ...
	 * @generated
	 */
	protected Vector2DBasedAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return UGSMLPackage.Literals.VECTOR2_DBASED_ATTRIBUTE;
	}
	...
	public void setFeatureName(String newFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.VECTOR2_DBASED_ATTRIBUTE__FEATURE_NAME,
	...
	public void setX(float newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.VECTOR2_DBASED_ATTRIBUTE__X, oldX, x));
	}
	...
	public void setY(float newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UGSMLPackage.VECTOR2_DBASED_ATTRIBUTE__Y, oldY, y));
	}
